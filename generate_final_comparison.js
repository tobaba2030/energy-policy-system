...
async function main() {
  ...
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "1. 理论创新性不足：NLP/BERT方法仅描述做法，未说明理论基础", font: FONT, size: 22 })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "2. 仅分析广东省，其他三省分析深度不足", font: FONT, size: 22 })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "3. 关键结论缺乏数据支撑", font: FONT, size: 22 })] }));
  ...
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "1. 增加理论创新章节，明确3-5个创新点", font: FONT, size: 22 })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "2. 补充数学模型推导", font: FONT, size: 22 })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "3. 深化案例分析", font: FONT, size: 22 })] }));
  ...
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "2. 技术前瞻性良好（82分），准确把握市场需求", font: FONT, size: 22 })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "3. 理论创新性较好（85分），定性分析完整", font: FONT, size: 22 })] }));
  ...
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "1. 构建电力交易商业模式理论框架", font: FONT, size: 22 })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "2. 完善风险分析", font: FONT, size: 22 })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "3. 增加专业图表", font: FONT, size: 22 })] }));
  ...
  children.push(new Paragraph({ indent: { firstLine: 240 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "【改进建议】", font: FONT, bold: true, size: 24, color: "FF8C00" })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "1. 深化4A评估模型的理论基础", font: FONT, size: 22 })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "2. 补充K-Means聚类详细过程", font: FONT, size: 22 })] }));
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, children: [new TextRun({ text: "3. 增加多场景验证", font: FONT, size: 22 })] }));
  ...
  children.push(new Paragraph({ indent: { firstLine: 480 }, spacing: { line: 360, lineRule: "auto" }, alignment: AlignmentType.JUSTIFIED, children: [new TextRun({ text: "4份报告整体质量较高，3份达到良好及以上水平，1份达到合格水平。报告4表现最为突出，综合评分达到83分（优秀），建议优先推进。", font: FONT, size: 24 })] }));
  ...
  fs.writeFileSync("c:\\AI学习资料\\mesheer\\4份报告对比分析报告_v2.docx", buffer);
  console.log("Word文档已生成: c:\\AI学习资料\\mesheer\\4份报告对比分析报告_v2.docx");
}
